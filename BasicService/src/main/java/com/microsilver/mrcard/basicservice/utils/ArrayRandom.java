...
/**
 * 
 * @Name com.heyin.ArrayRandom
 * @Description 
 * 
 * @Author huwei
 * @Version 2018年4月9日 上午9:54:44
...
public class ArrayRandom {
     ...
     * @return 数组
     */
    public static double[] random(int amount, int max) {
     ...
     */
    private static boolean exist(double num, double[] array, int need) {
